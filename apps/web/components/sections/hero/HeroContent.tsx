        ...
        <div className="mx-auto max-w-7xl px-6">
            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                    <Link
                        href="#link"
                        className="hover:bg-brand-light/50 dark:hover:border-brand/20 bg-muted group mx-auto flex w-fit items-center gap-2 sm:gap-4 rounded-full border p-1 pl-3 sm:pl-4 shadow-md shadow-black/5 transition-all duration-300 dark:border-t-white/5 dark:shadow-zinc-950">
                        <span className="text-foreground text-xs sm:text-sm flex items-center gap-1.5 sm:gap-2">
                            <span className="size-1 sm:size-1.5 rounded-full bg-brand animate-pulse" />
                            The Smartest Way to Save on Medicines
                        </span>
                        <span className="dark:border-background block h-3 sm:h-4 w-px border-l bg-white dark:bg-zinc-700"></span>
